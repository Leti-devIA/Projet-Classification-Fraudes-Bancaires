...
# Appliquer SMOTEENN avec barre de progression
print("🔄 Application de SMOTEENN...")
start_time = time.time()
...
# Définir les hyperparamètres pour KNeighborsClassifier avec GridSearchCV
# param_grid = {
#     'n_neighbors': [3, 5, 7],
